...
//  echo $_POST['submit']; die;
  ...
  if($username == "dmittal1" && $password == "123456")
  {
    ...
    //echo '<script type="text/javascript"> window.open("RUD.php","_self");</script>';
    //header("Location: RUD.php");
  }
          ...
          -->
					...
					<div class="col-md-5 order-md-1 signin-left-column bg-white px-5">
						...
						<form action="" method="post">
							...
							<button type="submit" name ="submit" class="btn btn-primary btn-gradient btn-block">
